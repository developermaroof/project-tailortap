...
const BankInfo = () => {
  ...
  const [screenshotPreview, setScreenshotPreview] = useState(ScreenShotPlaceholder);
          ...
          <div className='mt-10 flex flex-col gap-4'>
            ...
            <div>
              ...
              <label className='shadow-md gap-3 mt-4 shadow-gray-400 rounded-md cursor-pointer flex flex-col justify-center items-center p-6 text-center'>
                ...
                />
                <p className='text-xs'>
                  Upload your <span className='text-themeColor'>Screenshot</span> here to <br /> confirm purchase
                </p>
                <input
                  type='file'
                  accept='image/*'
