                ...
                <div className='flex flex-col gap-6'>
                    ...
                    <div className='flex flex-col justify-center items-center gap-10'>
                        ...
                        <div className='relative h-[280px]'>
                            <img src={PantShalwarLogo} alt="pantshalwarvector"  className='mt-6 w-[180px]'/>
                    ...
                    <div className='flex flex-col gap-4'>
                        <div>
                            <input 
                                ...
                                type="text" placeholder='Enter Pant / Shalwar' className='text-sm border-themeColor border-[1px] rounded-md w-full p-3'/>
                        </div>
                        <div className='flex flex-col gap-2'>
                            <button onClick={handleSavePantShalwar} className='font-bold font-poppins uppercase text-white cursor-pointer bg-themeColor rounded-md w-full p-2'>Next</button>
